...
Route::get('admin/banner/add', 'BannerController@addbanner')->name('addbanner');
Route::post('admin/banner/submit', 'BannerController@subbanner')->name('subbanner');
Route::get('admin/banner/manage', 'BannerController@managebanner')->name('managebanner');
