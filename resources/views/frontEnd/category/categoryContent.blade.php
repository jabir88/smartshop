...
<div class="men-wear">
	<div class="container">
						...
						<ul>
							<li><input type="checkbox" id="item-0-0" /><label for="item-0-0">Ethinic Wear</label>
								<ul>
									...
									<li><a href="{{url('/mens')}}">Caps</a></li>
									<li><a href="{{url('/mens')}}">Shoes</a></li>
									<li><a href="{{url('/mens')}}">Pants</a></li>
									<li><a href="{{url('/mens')}}">SunGlasses</a></li>
									<li><a href="{{url('/mens')}}">Trousers</a></li>
								</ul>
							</li>
		...
		<div class="col-md-8 products-right">
			...
			<div class="men-wear-top">
				...
				<div  id="top" class="callbacks_container">
					<ul class="rslides" id="slider3">
						<li>
							<img class="img-responsive" src="{{asset('front/images/')}}/men1.jpg" alt=" "/>
						</li>
						<li>
							<img class="img-responsive" src="{{asset('front/images/')}}/men2.jpg" alt=" "/>
						</li>
						<li>
							<img class="img-responsive" src="{{asset('front/images/')}}/men1.jpg" alt=" "/>
						</li>
			...
			<div class="men-wear-bottom">
				<div class="col-sm-4 men-wear-left">
					<img class="img-responsive" src="{{asset('front/images/')}}/men3.jpg" alt=" " />
				</div>
			...
			@foreach($produt_detail3 as $produt_detail3 )

				<div class="col-md-4 product-men no-pad-men">
					<div class="men-pro-item simpleCart_shelfItem">
						<div class="men-thumb-item">
							<img src="{{asset('/'.$produt_detail3->product_img)}}" height="250" alt="" class="pro-image-front">
							<img src="{{asset('/'.$produt_detail3->product_img)}}" height="250" alt="" class="pro-image-back">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="{{url('/single/'.$produt_detail3->pro_id)}}" class="link-product-add-cart">Quick View</a>
											</div>
										</div>
						...
						<div class="item-info-product ">
									<h4><a href="{{url('/single/'.$produt_detail3->pro_id)}}">{{$produt_detail3->product_name}}</a></h4>
									<div class="info-product-price">
										<span class="item_price">BDT {{$produt_detail3->product_price}}</span>

									</div>
									<a href="{{url('/single/'.$produt_detail3->pro_id)}}" class="item_add single-item hvr-outline-out button2">Add to cart</a>
						</div>
					</div>
				</div>
				@endforeach
		...
		<div class="single-pro">
			@foreach($produt_details as $produt_detail )
			<div class="col-md-3 product-men">
				<div class="men-pro-item simpleCart_shelfItem">
					<div class="men-thumb-item">
						<img src="{{asset('/'.$produt_detail->product_img)}}" alt="" height="250" class="pro-image-front">
						<img src="{{asset('/'.$produt_detail->product_img)}}" alt="" height="250" class="pro-image-back">
							<div class="men-cart-pro">
								<div class="inner-men-cart-pro">
									<a href="{{url('/single/'.$produt_detail->pro_id)}}" class="link-product-add-cart">Quick View</a>
								</div>
							</div>
							<span class="product-new-top">New</span>
					</div>
					<div class="item-info-product ">
						<h4><a href="{{url('/single/'.$produt_detail->pro_id)}}">{{$produt_detail->product_name}}</a></h4>
						<div class="info-product-price">
							<span class="item_price">BDT {{$produt_detail->product_price}}</span>
							<!-- <del>$69.71</del> -->
						</div>
						<a href="{{url('/single/'.$produt_detail->pro_id)}}" class="item_add single-item hvr-outline-out button2">Add to cart</a>
					</div>
				</div>
			</div>
			@endforeach
